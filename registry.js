...
const REGISTRY = [
  ...
  },
  {
    ...
    args: (c) => ['--input', c.f('normalised.las'),
                  ...
                  '--crs', c.crs,
                  '--out-summary', c.f('segment_summary.json'),
                  '--out-quality-geojson', c.f('stem_quality.geojson')],
    outputs: [
      ...
      { role: 'vector',  file: 'stem_quality.geojson', name: 'Stem quality', kind: 'stem_quality' },
      { role: 'summary', file: 'segment_summary.json', name: 'summary' },
    ],
  },
  {
    id: 'dbh',
